...
El entrenamiento base utiliza el algoritmo de gradiente de política REINFORCE, optimizando la esperanza del beneficio $J(\theta) = \mathbb{E}_{\tau \sim \pi_\theta} [R(\tau)]$.
...
Se implementó una estrategia de Temperature Scaling en la función Softmax:
